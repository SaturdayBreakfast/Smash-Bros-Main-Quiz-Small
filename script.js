$("#Maybe").click(function(){
    ...
    if (groundAirInput==="ground" && lightHeavyInput >= 70) {
    $("#answer").html("Someone like Donkey Kong or Ganondorf, who are better at close up battles, or King K. Rool, who can fight close or throw projectiles from far away.. Although being heavier means they're harder to knock off the stage, it also means it can can be hard to get back to the stage when you ARE off, again, with the exception of K.Rool. <img src=\"https://www.geek.com/wp-content/uploads/2018/11/king-k-rool-smash-ultimate-625x352.png\">"); }
    ...
    if (groundAirInput==="air" && lightHeavyInput <70) { 
         $("#answer").html("Someone like Kirby, Jigglypuff or Meta Knight, who are pretty light, but do well in air combat. <img src=\"https://www.smashbros.com/assets_v2/img/fighter/meta_knight/ss_5.jpg\">"); }
